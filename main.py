...
def main():
    ...
    for user in data['app_state']['gitopia']['userList']:
        cur.execute("INSERT INTO user (block_range, id, userid, creator, name, username, createdat, updatedat) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", 
                    (Range(empty=True), user['id'], user['id'], user['creator'], user['name'], user['username'], user['createdAt'], user['updatedAt']))
    ...
    for repository in data['app_state']['gitopia']['repositoryList']:
        cur.execute("INSERT INTO repository (block_range, id, creator, name, owner, owner_type, description, createdat, updatedat, archived, license, defaultbranch, parent, fork, collaborators, allowforking, enablearweavebackup) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", 
                    (Range(empty=True), repository['id'], repository['creator'], repository['name'], repository['owner']['id'], repository['owner']['type'], repository['description'], repository['createdAt'], repository['updatedAt'], repository['archived'], repository['license'], repository['defaultBranch'], repository['parent'], repository['fork'], repository['collaborators'], repository['allowForking'], repository['enableArweaveBackup']))
